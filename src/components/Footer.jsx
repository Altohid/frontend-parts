...
const Footer = () => {
  return (
    <>
        {/* CTA section placed just above footer (matches reference) */}
  {/* How it works section (buyers/sellers toggle) */}
  ...
  {/* Features section (from reference) */}
  <Features />

  {/* Sellers section (from reference) */}
  <Sellers />
 

        {/* Testimonials section (from reference) */}
        <Testimonials />

  {/* White brand strip (matches reference color) */}
  <div className="bg-white">
        <div className="container max-w-7xl mx-auto px-6 text-center py-6">
      ...
      >
        <div className="container max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-extrabold leading-tight tracking-tight mb-4">Ready to find your part?</h2>
            <p className="mx-auto max-w-2xl mt-2 text-white/90 text-lg">Average time to first matching listing: under 90 seconds. No signup needed to browse.</p>

            <div className="mt-10 flex justify-center gap-6">
              <Link to="/parts" className="bg-white text-olx-dark px-8 py-3.5 rounded-lg font-semibold shadow-md">Browse all parts →</Link>
              <Link to="/add-part" className="border border-white/30 text-white px-8 py-3.5 rounded-lg font-semibold">List a part free</Link>
            </div>
            ...
            <ul className="space-y-4 text-sm text-white/75 md:items-end">
              <li className="flex items-center justify-end gap-3">
                ...
                <div className="text-right">
                  <div className="font-semibold text-white whitespace-nowrap">+91 98765 43210</div>
              ...
              <li className="flex items-center justify-end gap-3">
                ...
                <a href="mailto:support@automart.com" className="font-medium hover:text-olx-teal transition-colors whitespace-nowrap">support@automart.com</a>
              </li>
